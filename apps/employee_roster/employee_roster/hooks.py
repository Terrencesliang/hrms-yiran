...
app_include_css = [
	...
	"/assets/employee_roster/css/unified_sidebar.css?v=20260904t",
	"/assets/employee_roster/org_ui/org_ui.css?v=20260904s",
...
app_include_js = [
	"/assets/employee_roster/org_ui/org_ui.js?v=20260904s",
	"/assets/employee_roster/js/recruiting_candidates.js",
	"/assets/employee_roster/js/unified_sidebar.js?v=20260904s",
