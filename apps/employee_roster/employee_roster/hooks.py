...
app_include_css = [
	...
	"/api/method/employee_roster.integrations.wecom.assets.org_ui_css?v=20260916r",
...
app_include_js = [
	...
	"/api/method/employee_roster.integrations.wecom.assets.org_ui_js?v=20260916r",
	"/assets/employee_roster/js/recruiting_candidates.js",
	"/assets/employee_roster/js/unified_sidebar.js?v=20260912i",
...
doctype_js = {
	# Employee form JS 改由 app_include_js 带 cache bust 加载，避免 Desk 缓存旧 doctype_js
...
boot_session = "employee_roster.hr_roster.boot.boot_session"
...
doc_events = {
	"Employee": {
		"after_insert": "employee_roster.hr_roster.account_service.ensure_employee_account",
...
# 	],
	"hourly": [
		"employee_roster.tasks.contracts.hourly",
		"employee_roster.tasks.wecom.sync_recent_attendance",
	],
	"daily": [
		"employee_roster.tasks.wecom.sync_contacts_daily",
	],
	"cron": {
		"17 2 * * *": [
			"employee_roster.tasks.contracts.cleanup"
		],
		"25 3 2 * *": [
			"employee_roster.tasks.wecom.prepare_previous_month_deductions",
		],
	},
# 	"weekly": [
